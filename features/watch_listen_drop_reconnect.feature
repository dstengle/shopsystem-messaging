Feature: shop-msg watch — bounded reconnect on LISTEN connection drop
  ...
  @scenario_hash:2426b67df01d4168 @bc:shopsystem-messaging
  ...
  @scenario_hash:641bae76c069bf5b @bc:shopsystem-messaging
  ...
  @scenario_hash:3df3c5993a4f60e5 @bc:shopsystem-messaging
