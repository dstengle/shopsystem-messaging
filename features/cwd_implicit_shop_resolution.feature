Feature: Implicit CWD-based shop resolution for shop-msg
  ...
  @scenario_hash:2d9704fcf6181cf9 @bc:shopsystem-messaging
  ...
  @scenario_hash:79c5b97fde233351 @bc:shopsystem-messaging
  ...
  @scenario_hash:bf89761a1a0b3254 @bc:shopsystem-messaging
  ...
  @scenario_hash:0eabd60b92f570c5 @bc:shopsystem-messaging
  ...
  @scenario_hash:490432bb7431ed7d @bc:shopsystem-messaging
  ...
  @scenario_hash:4bd7aaf110961822 @bc:shopsystem-messaging
  ...
  @scenario_hash:6492effd22a6d3e7 @bc:shopsystem-messaging
