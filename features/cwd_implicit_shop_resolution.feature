Feature: Implicit CWD-based shop resolution for shop-msg
  ...
  @scenario_hash:bad131a5760ad021 @bc:shopsystem-messaging
  ...
  @scenario_hash:c8f18b7f8396eea4 @bc:shopsystem-messaging
  ...
  @scenario_hash:6f2c4d22f92ae282 @bc:shopsystem-messaging
  ...
  @scenario_hash:e8003198468448cf @bc:shopsystem-messaging
  ...
  @scenario_hash:bae50ac8b89ef4be @bc:shopsystem-messaging
  ...
  @scenario_hash:9cd19c8974eeefeb @bc:shopsystem-messaging
  ...
  @scenario_hash:e55fbdf82ccc8fa9 @bc:shopsystem-messaging
  ...
  @scenario_hash:9e2dee7fa6cce3b9 @bc:shopsystem-messaging
