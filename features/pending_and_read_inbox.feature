Feature: shop-msg CLI surface — pending enumeration and inbox read
  ...
  @scenario_hash:dbba6458a21b3484 @bc:shopsystem-messaging
  ...
  @scenario_hash:d246eef56684a871 @bc:shopsystem-messaging
  ...
  @scenario_hash:ab7c5029713969e4 @bc:shopsystem-messaging
  ...
  @scenario_hash:5571b71a82cbd6b8 @bc:shopsystem-messaging
  ...
  @scenario_hash:d9543de2855e544c @bc:shopsystem-messaging
  ...
  @scenario_hash:a199948703bbaebe @bc:shopsystem-messaging
  ...
  @scenario_hash:a7bca94eea82b87f @bc:shopsystem-messaging
