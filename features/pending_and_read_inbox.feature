Feature: shop-msg CLI surface — pending enumeration and inbox read
  ...
  @scenario_hash:2f028ee351fc512c @bc:shopsystem-messaging
  ...
  @scenario_hash:dc27ddad94f50479 @bc:shopsystem-messaging
  ...
  @scenario_hash:2e585da377f68d5c @bc:shopsystem-messaging
  ...
  @scenario_hash:d71fb7f28c4cd561 @bc:shopsystem-messaging
  ...
  @scenario_hash:350af5ec19e38974 @bc:shopsystem-messaging
  ...
  @scenario_hash:6b191cfc691ede7f @bc:shopsystem-messaging
  ...
  @scenario_hash:92021082218ffa87 @bc:shopsystem-messaging
