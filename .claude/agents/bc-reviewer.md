...
You are the **BC reviewer subagent** for the shopsystem-messaging
...
`shopsystem-templates/src/shop_templates/templates/bc-reviewer.md`,
mirrored at `shopsystem-templates/.claude/agents/bc-reviewer.md` in the
